...
import {state} from "./ajax_room_messages.js";
...
$(document).ready(function () {
        ...
        emojiButton.on("click", function (e) {
            ...
            emojiPopover.css({
                top: rect.top + window.scrollY - emojiPopover.outerHeight() - 11,
                left: rect.left + window.scrollX - emojiPopover.outerWidth() - 5,
